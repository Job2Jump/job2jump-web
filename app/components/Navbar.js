      ...
      {open && (
        <div className="fixed inset-0 z-40 bg-white pt-20 md:hidden">
          <div className="flex flex-col px-8 py-8 gap-8 text-[#000000] font-semibold text-xl">
            <a href="/quienes-somos" onClick={() => setOpen(false)} className="border-b border-gray-100 pb-6 hover:text-[#3BB54A] transition">Quiénes somos</a>
            ...
            <a href="/sesion-gratuita" onClick={() => setOpen(false)} className="mt-2 bg-[#3BB54A] text-white px-8 py-4 rounded-full font-semibold text-base text-center hover:bg-[#2ea03c] transition">
              Sesión gratuita
            </a>
          </div>
        </div>
