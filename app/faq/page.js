      ...
      <section className="pt-40 pb-16 bg-[#000000]">
        <div className="max-w-3xl mx-auto px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a href="tel:628673623" className="flex items-center justify-center gap-2 bg-[#7A9E3B] text-white px-6 py-3 rounded-full text-sm font-semibold hover:bg-[#2ea03c] transition">
