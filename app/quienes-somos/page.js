...
export default function QuienesSomos() {
  return (
    <div className="min-h-screen font-sans">
      ...
      {/* HERO */}
      <section className="pt-40 pb-24 bg-[#0F2B4A]">
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl font-bold text-[#0F2B4A] mt-3 mb-2">Celia Salgado Mena</h2>
              ...
              <div className="flex gap-4 mt-8">
                <a href="https://instagram.com/job2jump" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-[#F0F4F8] text-[#0F2B4A] px-4 py-2 rounded-full text-sm font-semibold hover:bg-[#3BB54A] hover:text-white transition">
      ...
      <section className="py-20 bg-[#F0F4F8]">
        <div className="max-w-7xl mx-auto px-8 text-center">
          ...
          <h2 className="text-3xl font-bold text-[#0F2B4A] mt-3 mb-4">Mucho contenido gratuito en redes</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://instagram.com/job2jump" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-3 bg-[#0F2B4A] text-white px-8 py-4 rounded-full font-semibold text-base hover:bg-[#1a3d6b] transition">
      ...
      <section className="py-24 bg-[#F0F4F8]">
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold text-[#0F2B4A] mt-3">Lo que nos diferencia</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="bg-white rounded-2xl p-8 border border-gray-100">
                ...
                <h3 className="text-base font-bold text-[#0F2B4A] mb-2">{item.titulo}</h3>
